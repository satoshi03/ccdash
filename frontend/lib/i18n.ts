...
export const translations: Record<Language, Translations> = {
  ja: {
    ...
    session: {
      ...
      command: 'コマンド',
      output: '出力',
      commandHint: 'Shift + Enter でコマンドを実行',
      yoloMode: 'YOLOモード (権限をスキップ)',
      asyncExecution: '非同期実行 (推奨)',
      polling: '監視中...',
      jobId: 'ジョブID',
      jobManagementError: 'ジョブ管理エラー',
    },
    errors: {
  ...
  en: {
    ...
    session: {
      ...
      command: 'Command',
      output: 'Output',
      commandHint: 'Press Shift + Enter to execute command',
      yoloMode: 'YOLO Mode (skip permissions)',
      asyncExecution: 'Async Execution (recommended)',
      polling: 'Polling...',
      jobId: 'Job ID',
      jobManagementError: 'Job Management Error',
    },
    errors: {
