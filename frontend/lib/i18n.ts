...
export const translations: Record<Language, Translations> = {
  ja: {
    ...
    auth: {
      ...
      description: 'CCDashにアクセスするためのAPIキーを入力してください',
      authenticate: '認証',
      authenticating: '検証中...',
      logout: 'ログアウト',
      status: {
        ...
        apiKeySet: 'APIキーが設定されています',
      },
      errors: {
        required: 'APIキーを入力してください',
        invalid: '無効なAPIキーです。正しいAPIキーを入力してください。',
      },
      securityNote: 'APIキーはブラウザのセッションストレージに安全に保存されます',
    },
  },
  en: {
    common: {
    ...
    auth: {
      ...
      description: 'Enter your API key to access CCDash',
      ...
      errors: {
        ...
        invalid: 'Invalid API key. Please enter a valid API key.',
      },
      securityNote: 'API key is securely stored in browser session storage',
    },
  },
}
