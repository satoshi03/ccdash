...
ccdash --backend-url http://api.example.com --frontend-url https://app.example.com
```
...
# Start with custom URLs
npx ccdash --backend-url http://api.example.com --frontend-url https://app.example.com
npx ccdash -bu http://localhost:8081 -fu http://localhost:3001
