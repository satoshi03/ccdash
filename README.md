...
Claudeee is a tool that visualizes Claude Code usage and helps with efficient task management. It supports monitoring token usage, managing sessions, and will support automatic task scheduling in the future.
...
Claudeee offers the following commands:
...
#### Backend
  ...
  - `DB_PATH`: Path to the database file (default: `~/.claudeee/claudeee.db`)
...
Claudeee parses JSONL log files generated by Claude Code.
